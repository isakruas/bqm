...
urlpatterns = [
    ...
    # path('api/v1/token/bearer/', TokenObtainPairView.as_view(), name='token_obtain_pair'),
    # path('api/v1/token/bearer/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    # path('api/v1/token/bearer/verify/', TokenVerifyView.as_view(), name='token_verify'),
